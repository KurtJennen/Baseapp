...
public class FlatFileItemDatabaseReader<T> extends AbstractItemCountingItemStreamItemReader<T> implements
	...
	public FlatFileItemDatabaseReader() {
		setName(ClassUtils.getShortName(FlatFileItemDatabaseReader.class));
	}
	...
	protected void doOpen() throws Exception {
		...
		if (!resource.exists()) {
			...
			Logging.warn(this, "Input resource does not exist " + resource.getDescription());
			return;
		}
		...
		if (!resource.isReadable()) {
			...
			Logging.warn(this, "Input resource is not readable " + resource.getDescription());
			return;
		}
